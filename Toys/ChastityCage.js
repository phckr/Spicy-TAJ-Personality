...
function setupNewCage() {
    ...
    if (canUseCamera() && tryTakePhoto("Hold it in front of the camera and tell me when you are ready (or just paste an image in).", getChastityImagePath(name), { delay: 3 })) {
